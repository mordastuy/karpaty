...
class Controller_Backend_Main extends Controller_Backend {
    ...
    public function action_add() {
        ...
        $content = View::factory('backend/main/v_main_add', array('languages' => $languages));
        ...
        if (isset($_POST['submit'])) {
            $from_form = Arr::extract($_POST, array('language', 'text', 'image'));
            $subpage_id = Model::factory('Main')->add_main(1, $from_form['language'], $from_form['text']);
